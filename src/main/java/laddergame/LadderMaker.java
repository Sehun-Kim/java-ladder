...
public class LadderMaker {
    ...
    public static String drawLine(ArrayList<Integer> line) {
    ...
    public static String checkPoint(int point){
        StringBuilder sb = new StringBuilder();
        switch (point){
            case Line.HORIZONTAL : sb.append(HORIZONTAL); break;
            case Line.NONE : sb.append(NONE); break;
            case Line.VERTICAL : sb.append(VERTICAL); break;
            default : break;
        }
        return sb.toString();
    }
